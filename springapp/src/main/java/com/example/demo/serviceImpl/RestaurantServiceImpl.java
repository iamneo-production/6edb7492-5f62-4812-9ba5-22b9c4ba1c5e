...
public class RestaurantServiceImpl implements RestaurantService {
	...
	public String addRestaurant(RestaurantsDTO rest) {
		...
		{
			Restaurants restaurants=new Restaurants(rest.getRestaurantId(),rest.getRestaurantName(),rest.getRestaurantLocation(),rest.getRestaurantEmail(),rest.getRestaurantPassword(),rest.getRestaurantmenu());
