...
export const OwnerRegister = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (pass.length < 8) {
      ...
      e.preventDefault();
      try {
        const response = await fetch(`${baseUrl}/restaurantregistration`, {
          method: 'POST',
          headers: {
    ...
    <div className="login-overlay">
      <div className="auth-form-container">
        ...
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          <input value={location} name="location" onChange={(e) => setLocation(e.target.value)} id="Restaurant Location" placeholder="location of Restaurant" required />
